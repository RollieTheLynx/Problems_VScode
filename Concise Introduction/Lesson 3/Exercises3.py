...
"""
#%%
def name_phone(csvfile):
    
    import csv
    f = open(csvfile, 'w', newline = "") # open the csv file here
    
    while True:
        nextname = input("Enter a friend's name, press return to end: ")
        if nextname == "":
            break
        nextphone = input("Enter your friend's phone: ")              # break jumps out of the loop
        line = []
