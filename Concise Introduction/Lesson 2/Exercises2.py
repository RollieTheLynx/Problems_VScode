...
def average(numlis):
    ...
    for n in numlis:
        total = n + total
        aver = total / len(numlis)
    print("Total is",total,"Average is",aver,"count is",len(numlis))
...
def average(nlis):
    total = 0
    for boob in range(0,len(nlis)):
        total = boob + total
        average = total / len(nlis)
        print(nlis[boob], end = " ")
    print()
    print("The average is",average,"count is",len(nlis))
